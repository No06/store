...
public class UserAddressServiceImpl implements UserAddressService {
    ...
    @Override
    public UserAddress findById(Long id) throws UserAddressNotFoundException {
        return addressRepository.findById(id).orElseThrow(() -> new UserAddressNotFoundException("ID: "+id));
    }
